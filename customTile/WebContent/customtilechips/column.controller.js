...
(function () {
    ...
    sap.ui.controller("customtilechips.column", {
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            var
                oViewModel = oSettingsView.getMainModel(),
        ...
        onSaveConfiguration: function (oConfigurationView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "customtilechips.column.controller");
        ...
        loadData: function (oDynamicTileView, nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "customtilechips.column.controller"
                );
                // call again later
